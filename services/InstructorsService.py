...
def create_instructor(instructor_id, first_name, last_name, email, ssn, bank_routing_number, bank_account_number):
    new_instructor = Instructor(instructor_id=instructor_id, first_name=first_name, last_name=last_name, email=email,
                                ssn=ssn, bank_routing_number=bank_routing_number, bank_account_number=bank_account_number)
    new_instructor.save()
