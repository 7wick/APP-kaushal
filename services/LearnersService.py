...
def initialize_learners(database_name):  # Initialize the db with default learners
    ...
    Learner(learner_id=1231, first_name="Heer", last_name="Kaul", email="learner1@cmu.edu", education="high school").save()
    Learner(learner_id=1232, first_name="Jordan", last_name="Jackson", email="learner2@cmu.edu", education="undergraduate").save()
    Learner(learner_id=1233, first_name="Jordan", last_name="Mishra", email="learner3@cmu.edu", education="graduate").save()
    Learner(learner_id=1234, first_name="Shivali", last_name="Mittal", email="learner4@cmu.edu", education="no school").save()
